...
- `index.html`: The final output of the template when the header variable `PDF_EXPORT` is set to `FALSE`. View it at [file:///Users/carlydeal/Documents/GitHub/cv/resume.html](file:///Users/carlydeal/Documents/GitHub/cv/resume.html).
